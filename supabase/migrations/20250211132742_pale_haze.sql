/*
  # Update fuel data table with correct column names

  1. Table Structure
    - fuel_data table with correct column names
    - co2eq_wtw_gco2eq_per_mj for CO2 equivalent
    - lcv_mj_per_gfuel for Lower Calorific Value
